public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: removed value in slot 1 instead of 0, which doesn't exist in this test
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue adds to the beginning instead of the end, putting the numbers backwards order
